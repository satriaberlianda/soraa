        ...
        try:
            r = requests.post(
                ...
                headers={
                    ...
                    **(
                        {
                            "HTTP-Referer": "https://sora.intellence.cloud/",
                            "X-Title": "Sora Intellence",
                        }
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "Sora Intellence: Server Connection Error",
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="Sora Intellence: Server Connection Error"
                )
            except Exception as e:
...
async def generate_chat_completion(
    ...
    if url == 'http://localhost:2000':
        if model_id == 'sora-assistant':
            headers = {
                "X-Forwarded-Host": "api.intellence.cloud",
                "X-Forwarded-Server": "api.intellence.cloud",
                "Host": "api.intellence.cloud",
                "Authorization": f"Bearer micyna",
                "Content-Type": "application/json",
            }
        else:
            headers = {
